...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="relative rounded-full border border-transparent dark:bg-black dark:border-white/20 shadow-input flex justify-center space-x-4 px-8 py-6 text-white"
    >
      {children}
    </nav>
  );
